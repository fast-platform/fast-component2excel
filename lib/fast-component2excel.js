...
function getShape(json) {
  ...
  var rowCount = (0, _getRows.getRows)(comps, 0);
  var colCount = (0, _getColumns.getColumns)();
...
function countTableObjectRows(rows) {
  ...
  console.log('reduced sum', tableRows.reduce(function (a, b) {
    return a + b;
  }, 0));
