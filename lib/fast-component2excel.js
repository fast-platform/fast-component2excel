(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("fast-component2excel", [], factory);
	else if(typeof exports === 'object')
		exports["fast-component2excel"] = factory();
	else
		root["fast-component2excel"] = factory();
})(window, function() {
...
var url = 'https://ixjjftxezpoomka.form.io/a';

var json = '';

_axios2.default.get(url).then(function (response) {
  json = response.data;
  _Converter2.default.convertJsonToFile(json);
});

exports.default = _Converter2.default;
...
var _getShape = __webpack_require__(2);
...
var Converter = function () {
  ...
  _createClass(Converter, null, [{
    key: 'convertJsonToFile',
    value: function convertJsonToFile(json) {
      (0, _getShape.getShape)(json);
    }
  }]);
...
var _getRows = __webpack_require__(3);

var _getColumns = __webpack_require__(4);
...
function getShape(json) {
  ...
  var rowCount = (0, _getRows.getRows)(comps);
  var colCount = (0, _getColumns.getColumns)(comps);
...
function countColumnObjectRows(columns) {
  ...
  return Math.max.apply(Math, columnRows);
}
...
function countTableObjectRows(rows) {
  ...
  try {
    for (var _iterator2 = rows[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      tableRows.push(Math.max.apply(Math, rowMax));
    }
  } catch (err) {
  ...
  return tableRows.reduce(function (a, b) {
    return a + b;
  }, 0);
}

function getRows(tree) {
  ...
  try {
    for (var _iterator4 = tree[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      ...
      if (comp.type !== 'datagrid' & comp.type !== 'columns' & comp.type !== 'table' & comp.type !== 'editgrid' & comp.type !== 'fieldset') {
        rows = rows + 1;
      } else {
...
function countColumnObjectCols(columns) {
  ...
  return columnCols.reduce(function (a, b) {
    return a + b;
  }, 0);
}
...
function countTableCols(rows) {
  ...
  return Math.max.apply(Math, maxCols);
}
...
function getColumns(tree) {
  ...
  try {
    for (var _iterator4 = tree[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      ...
      if (comp.type !== 'table' & comp.type !== 'columns' & comp.type !== 'datagrid' & comp.type !== 'editgrid' & comp.type !== 'fieldset') {
        cols.push(1);
      } else {
...
//# sourceMappingURL=fast-component2excel.js.map